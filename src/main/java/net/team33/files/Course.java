...
public class Course implements Runnable {
    ...
    private Course(final Catching catching) {
    ...
    public final Course apply(final Consumer consumer) {
    ...
    public static class Catching {
        ...
        public final Course apply(final Consumer consumer) {
            return new Course(this).apply(consumer);
        }

        public final When when(final Predicate predicate) {
            return new When(new Course(this), predicate);
        }
    ...
    public static class When {
        ...
        private When(final Course course, final Predicate predicate) {
            this.course = course;
            this.predicate = predicate;
        }

        public Course apply(final Consumer consumer) {
            return course.apply(path -> {
