...
public class CourseTest {
    ...
    public static final Course.Predicate IS_REGULAR_FILE = path -> Files.isRegularFile(path, LinkOption.NOFOLLOW_LINKS);
    public static final Course.Predicate IS_DIRECTORY = path -> Files.isDirectory(path, LinkOption.NOFOLLOW_LINKS);
